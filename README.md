# Warning:
As of writing this, both TPM and SecureBoot have vulnerabilities, unless you just want to learn about them. I would discourage from using those parts of the guide. The encryption part is still relevant.
